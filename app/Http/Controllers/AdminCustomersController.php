...
class AdminCustomersController extends CBController {
	...
	public function cbInit() {
			...
			$this->col[] = ["label"=>"رابط العنوان الاول","name"=>"location_link_1"];
			$this->col[] = ["label"=>"العنوان الاول","name"=>"location_text_1"];
			$this->col[] = ["label"=>"رابط العنوان الثاني","name"=>"location_link_2"];
			$this->col[] = ["label"=>"العنوان الثاني","name"=>"location_text_2"];
